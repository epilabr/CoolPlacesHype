...
public class SearchFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        distanceSeekBar.getProgressDrawable().setColorFilter(
            ...
            try {
                ...
                if (intent.getAction().equals("finalProject.FINISHED")) {
                 ...
                 /*============parses the json======================*/
                    ...
                    placesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {//starts map activity onclick
                        @Override
                    ...
                    placesListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {//starts dialog on long click
                        @Override
    ...
    @Override
    public void onResume() { //on resume refreshes display
        super.onResume();
        ...
        placesListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {//on item long click shows dialog
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            builder.setItems(R.array.dialog_options, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    switch (which) {
                        ...
                        case (0):  //this dialog choice saves to favorites
                        ...
                        case (1):  //this dialog choice sends interests location to friend
                            try {
                        ...
                        case (2):  //this dialog choice starts navigation to interests position
